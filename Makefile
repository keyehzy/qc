...
SOURCES = src/main.cpp src/orbital.cpp src/basis_set.cpp src/hartree_fock/restricted_hf.cpp src/hartree_fock/unrestricted_hf.cpp src/lda.cpp src/uniform_grid.cpp src/atom_centered_grid.cpp
